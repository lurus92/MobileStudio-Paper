...
\fancyhead[C]{Mobile Studio $\bullet$ July 2017} % Custom header text
...
\title{%
  Mobile Studio \\
  \large A Framework for the Development \\
  of NativeScript Mobile Applications}

\author{%
\textsc{Luigi Russo}\thanks{Luciano Baresi} \\[1ex] % Your name
\normalsize Politecnico di Milano \\ % Your institution
\normalsize \href{mailto:luigi.russo3@mail.polimi.com}{luigi.russo3@mail.polimi.com} % Your email address
